...
Use this tree for mechanical, electrical, interface, and BOM source artifacts.

Recommended organization:

- `mechanical/` — CAD, drawings, calculations, fabrication records.
- `electrical/` — schematics, wiring, PCB, power architecture, component records.
